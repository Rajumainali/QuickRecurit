...
const DashNavbar = ({ details }: { details: { firstName?: string; profile?: string | null } }) => {
...
navigate("/login");
  ...
  <NavigationMenuItem>
    <div className="flex items-center gap-3 px-4 py-2">
      ...
      <span className="text-sm font-medium">Welcome back, {details.firstName}!</span>
    </div>
  </NavigationMenuItem>
)}
  ...
  <div className="flex items-center gap-3 mt-6 p-4 rounded-xl bg-gray-100 dark:bg-gray-800">
    ...
    <div className="text-sm font-medium dark:text-white">
      Welcome back,<br /> {details.firstName}!
    </div>
  </div>
)}
