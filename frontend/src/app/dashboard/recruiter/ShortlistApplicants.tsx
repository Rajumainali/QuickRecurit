                  ...
                  <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-1">
                      ...
                      {hiddenApplicants.size > 0 && (
                        <span className="text-xs ml-2 px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded-full">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-3 mt-4">
                                ...
                                <button
                                  ...
                                  className="flex items-center gap-1 px-3 py-1 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded-md hover:bg-red-200 dark:hover:bg-red-900/50 transition-colors text-sm"
                                  type="button"
                                >
                                  <X className="w-4 h-4" />
                                  Reject
